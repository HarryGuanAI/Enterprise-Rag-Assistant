...
- 初始上线 8 份 `sample_docs/` 虚构企业文档导入，36 个 chunks 入库。
- 当前样例知识库已升级为 11 份企业制度文档，覆盖 Markdown、TXT、DOCX、PDF；本地纯净验证生成 57 个 chunks。
- 当前 golden QA 已扩展到 73 条，覆盖制度细则、刁钻边界问题和拒答问题。
...
| 阶段 7：基础评测集 | 已完成 | 73 条 golden QA，Hybrid + Rerank 本地纯净验证三项指标均为 1.00 |
